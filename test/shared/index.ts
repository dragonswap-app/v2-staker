...
import { IDragonswapV2Pool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: IDragonswapV2Pool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: IDragonswapV2Pool): Promise<number> => (await getSlot0(pool)).tick
