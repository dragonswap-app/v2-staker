...
import '@dragonswap/v2-periphery/contracts/interfaces/IMulticall.sol';

/// @title Dragonswap V2 Staker Interface
/// @notice Allows staking nonfungible liquidity tokens in exchange for reward tokens
interface IDragonswapV2Staker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The Dragonswap V2 pool
    ...
    /// @notice The Dragonswap V2 Factory
    function factory() external view returns (IDragonswapV2Factory);
    ...
    /// @notice Withdraws a Dragonswap V2 LP token `tokenId` from this contract to the recipient `to`
    ...
    event IncentiveCreated(
        ...
        IDragonswapV2Pool indexed pool,
        uint256 startTime,
        uint256 endTime,
        address refundee,
        uint256 reward
    ...
    /// @notice Event emitted when a Dragonswap V2 LP token has been staked
    /// @param tokenId The unique identifier of an Dragonswap V2 LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a Dragonswap V2 LP token has been unstaked
    /// @param tokenId The unique identifier of an Dragonswap V2 LP token
    /// @param incentiveId The incentive in which the token is staking
